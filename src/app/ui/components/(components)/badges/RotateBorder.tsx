const RotateBorder = () => {
  return (
    <div className="relative inline-flex overflow-hidden rounded-full p-px">
      ...
      <span className="inline-flex h-full w-full items-center justify-center rounded-full bg-neutral-950 px-3 py-1 text-lg font-medium text-gray-50 backdrop-blur-3xl">
        Badge
      </span>
    </div>
  );
